...
export function ContainerInquiryForm({ listingId }: ContainerInquiryFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="grid gap-3 rounded-xl border border-neutral-800 bg-neutral-900/60 p-4">
      <h2 className="text-lg font-semibold text-neutral-100">Wyslij zapytanie</h2>

      <label className="grid gap-1 text-sm">
        <span className="text-neutral-300">Imie i nazwisko *</span>
        <input
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <label className="grid gap-1 text-sm">
          <span className="text-neutral-300">Oczekiwana ilosc</span>
          <input
            type="number"
            min={1}
        ...
        <label className="grid gap-1 text-sm">
          <span className="text-neutral-300">Proponowana cena</span>
          <input
      ...
      <label className="grid gap-1 text-sm">
        <span className="text-neutral-300">Wiadomosc *</span>
        <textarea
          rows={5}
